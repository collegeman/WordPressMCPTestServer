...
<p class="has-text-align-center has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e('Built For The Future', 'ollie'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center"} -->
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e('Get a 40 hour head start', 'ollie'); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e('Building with blocks and patterns is super easy and fun! You can design beautiful landing pages with just a few clicks.', 'ollie'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-primary-alt-color has-text-color"><strong><?php esc_html_e('✴', 'ollie'); ?></strong></p>
<!-- /wp:paragraph -->
...
<p class="has-base-color has-text-color has-link-color" style="font-style:normal;font-weight:600"><?php esc_html_e('Customize with clicks, not code', 'ollie'); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100 has-custom-font-size is-style-button-light has-x-small-font-size"><a class="wp-block-button__link wp-element-button"><?php esc_html_e('Learn More', 'ollie'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
<p class="has-base-color has-text-color has-link-color" style="font-style:normal;font-weight:600"><?php esc_html_e('Pixel perfect responsive design', 'ollie'); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
<p class="has-base-color has-text-color has-link-color" style="font-style:normal;font-weight:600"><?php esc_html_e('Blazing fast performance', 'ollie'); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
<p class="has-base-color has-text-color has-link-color" style="font-style:normal;font-weight:600"><?php esc_html_e('Build with beautiful patterns', 'ollie'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('Creating unique designs has never been easier. Ollie\'s growing pattern library puts expertly designed patterns at your fingertips.', 'ollie'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
<p class="has-base-color has-text-color has-link-color" style="font-style:normal;font-weight:600"><?php esc_html_e('Gorgeous typography', 'ollie'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('Finely-crafted typography that makes your content shine and automatically scales down to the perfect size on every device.', 'ollie'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
<p class="has-base-color has-text-color has-link-color" style="font-style:normal;font-weight:600"><?php esc_html_e('Launch quicker', 'ollie'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('Ollie launches with built-in pattern designs, page templates, style variations and more so you can get your site launched quickly.', 'ollie'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
