...
<!-- wp:group {"metadata":{"name":"Text"},"style":{"spacing":{"blockGap":"5px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"base"} -->
<p class="has-base-font-size"><strong><?php esc_html_e('Version Control', 'ollie'); ?></strong></p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"metadata":{"name":"Text"},"style":{"spacing":{"blockGap":"5px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"base"} -->
<p class="has-base-font-size"><strong><?php esc_html_e('Team Comments', 'ollie'); ?></strong></p>
<!-- /wp:paragraph -->
...
<p class="has-small-font-size"><?php esc_html_e('Start building smarter and faster today!', 'ollie'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"className":"ollie-no-shrink"} -->
<div class="wp-block-button ollie-no-shrink"><a class="wp-block-button__link wp-element-button"><?php esc_html_e('Get Started', 'ollie'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
